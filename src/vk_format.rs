...
//!
//! This module defines the Vulkan format type that corresponds to the
//! VkFormat values used in the KTX2 library.

/// Vulkan format type
///
/// This represents the VkFormat values from the Vulkan specification.
/// Contains all standard Vulkan format constants including UNORM, SNORM,
/// USCALED, SSCALED, UINT, SINT, SRGB, SFLOAT, compressed formats (BC, ETC2, ASTC),
/// and depth/stencil formats.
///
/// Derived from ash (https://github.com/ash-rs/ash) - Copyright (c) 2016 ash-rs developers - Licensed under MIT/Apache-2.0
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash, Default)]
#[repr(transparent)]
#[doc = "<https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkFormat.html>"]
pub struct VkFormat(pub(crate) i32);
impl VkFormat {
    #[inline]
